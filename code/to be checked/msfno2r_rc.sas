...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_cvd_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_ihd_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_chf_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_cbv_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_resp_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_copd_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_pneu_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_uri_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_ards_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_seps_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_VaD_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_AD_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_NeD_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_UsD_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_diabt1_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_diabt2_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_diab_t
	from enrollee_pm
...
/* ICD CODE or 1-8 Underlying Cause of Death*/
	...
	select zip_code, year, month, enrollee_age, sex, race, count(distinct BENE_ID) as no_death_kidn_t
	from enrollee_pm
...
proc export 
	data=master_cuz_ses
	outfile='/scratch/fatemehkp/projects/data/csv/master_ndi_pm.csv'  
	dbms=csv replace;
run;
