...
data master_cuz_ses; 
	...
	no2agel=no2_1yr*agel;
	no2agem=no2_1yr*agem;
	no2sexF=no2_1yr*sexF;
	no2sexM=no2_1yr*sexM;
	no2raceW=no2_1yr*raceW;
	no2raceNW=no2_1yr*raceNW;
run;
...
proc export 
	data=master_cuz_ses
	outfile='/scratch/fatemehkp/projects/Zipcode PM NO2/data/analysis/ndi-no2-zipcd-asr.csv'  
	dbms=csv replace;
run;
