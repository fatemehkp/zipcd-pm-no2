...
data enrollee_no2; 
	...
	where sex ne 'U' and pm_1yr ne . and no2_1yr ne . and ses_zip ne . and ses_tertile ne .;
run;
...
data master_cuz_sescat; 
	...
	no2sesL=no2_1yr*sesL;
	no2sesM=no2_1yr*sesM;
	no2sesH=no2_1yr*sesH;
	drop ses_tertile;
run;
...
proc export 
	data=master_cuz_sescat
	outfile='/scratch/fatemehkp/projects/Zipcode PM NO2/data/analysis/ndi-no2-zipcd-urban-sescat.csv'   
	dbms=csv replace;
run;
