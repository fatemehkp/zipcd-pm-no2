/* Created by Fatemeh K (07-28-2022)																*/
...
proc sql;
	create table master_cuz_brfss as
	select *
	from  master_cuz a
	inner join ses.brfss_zipcd b
	on a.zip_code=b.zip_code and a.year=b.year and a.month=b.month;
quit;

data master_cuz_brfss; length StrID $6.; 
	set master_cuz_brfss;
...
proc export 
	data=master_cuz_brfss
	outfile='/scratch/fatemehkp/projects/Zipcode Ozone PM/data/analysis/ndi-o3-zipcd-brfss.csv'  
	dbms=csv replace;
run;
