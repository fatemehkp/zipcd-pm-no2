...
data master_cuz_ses; 
	...
	no2raceA=no2_1yr*raceA;
	no2raceB=no2_1yr*raceB;
	no2raceH=no2_1yr*raceH;
	no2raceN=no2_1yr*raceN;
	no2raceW=no2_1yr*raceW;
	no2raceO=no2_1yr*raceO;
run;
...
proc export 
	data=master_cuz_ses
	outfile='/scratch/fatemehkp/projects/Zipcode PM NO2/data/analysis/ndi-no2-zipcd-race.csv'  
	dbms=csv replace;
run;
