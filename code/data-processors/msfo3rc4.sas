/* Created by Fatemeh K (01-02-2021) (09-06-2022)																*/
...
/* ICD CODE */
	...
	from enrollee_pm
	where diabt1=1 or diabt2=1 or diabt1_rc =1  or diabt2=1
	group by zip_code, year, month, enrollee_age, sex, race;
...
data master_cuz;
	merge master_enrollee_byzip master_death_byzip4 master_death_byzip5 master_death_byzip6
...
proc datasets nolist;
	delete master_enrollee_byzip master_death_byzip4 master_death_byzip5 master_death_byzip6
								master_death_byzip7 master_death_byzip8 master_death_byzip9
								master_death_byzip10 master_death_byzip11 master_death_byzip12
								master_death_byzip13 
								master_death_byzip16 master_death_byzip17 master_death_byzip18
